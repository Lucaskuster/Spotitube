...
class TracksControllerTest {
    ...
    void trackTypeTest() {
        ...
        when(tracksDAO.getAllTracksDTO(token, playlistId)).thenReturn(tracksDTO);
    ...
    void trackIncorrectPlaylistIdTest() {
        ...
        when(tracksDAO.getAllTracksDTO(token, playlistId)).thenThrow(new WrongPlaylistIdException());
    ...
    void trackIncorrectTokenTest() {
        ...
        when(tracksDAO.getAllTracksDTO(token, playlistId)).thenThrow(new IncorrectTokenException());
    ...
    void trackServerError() {
        ...
        when(tracksDAO.getAllTracksDTO(token, playlistId)).thenThrow(new ServerErrorException(500));
